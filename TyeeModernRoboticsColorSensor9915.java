 ...
 *
 */
public class TyeeModernRoboticsColorSensor9915 implements I2cController.I2cPortReadyCallback, ColorSensor {
    ...
    public TyeeModernRoboticsColorSensor9915(DeviceInterfaceModule deviceInterfaceModule, int physicalPort) {
        ...
        deviceInterfaceModule.enableI2cReadMode(physicalPort, I2cAddr.create8bit(ADDRESS_I2C), ADDRESS_COMMAND, BUFFER_LENGTH);
    ...
    public void portIsReady(int port) {
        ...
        if(this.f == SATTE.WRITE_DIRTY) {
            this.a.enableI2cWriteMode(this.h, I2cAddr.create8bit(ADDRESS_I2C), ADDRESS_COMMAND, BUFFER_LENGTH);
